...
public class SubscribedList extends AppCompatActivity{
    ...
    public void showList() {
        ...
        for(int i = 0; i < allSubscribedList; i++) {
            ...
            //ImageView imageView = (ImageView ) placeSubscribed.findViewById(R.id.imageView3);
            TextView textView = placeSubscribed.findViewById(R.id.place_name);
            textView.setText(subcribedList.get(i));
